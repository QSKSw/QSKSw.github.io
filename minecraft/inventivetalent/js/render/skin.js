...
(function (window) {
    ...
    var createPlayerModel = function (skinTexture, capeTexture, v, slim) {
        ...
        leftArmGroup.position.x = slim ? -5.8 : -6.4;
        leftArmGroup.position.y = 19.2;
        leftArmGroup.position.z = 0;
		leftArmGroup.rotation.z = toRadians(-5);
        ...
        rightArmGroup.position.x = slim ? 5.8 : 6.4;
        rightArmGroup.position.y = 19;
        rightArmGroup.position.z = 0;
		rightArmGroup.rotation.z = toRadians(5);
